"""
from: https://github.com/Phlya/adjustText/blob/master/adjustText/adjustText.py
credit to: https://github.com/Phlya/adjustText/commits/master/adjustText/adjustText.py?author=Phlya
MIT License
"""
